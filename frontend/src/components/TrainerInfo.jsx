      ...
      <div className="text-center">
        ...
        <div className="space-y-3">
          <a
            ...
            className="flex items-center justify-center space-x-3 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-bold text-lg transition-colors duration-200"
          >
